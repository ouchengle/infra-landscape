    ...
    export default {
        ...
        methods: {
            createGraph() {
                ...
                // setInterval(() => {
                //     this.nodesData.nodes[0].label = this.nodesData.nodes[0].label + 1
                //     this.nodesData.nodes[5].label = this.nodesData.nodes[5].label + 1
                //     this.nodesData.nodes[9].label = this.nodesData.nodes[9].label + 1
                //     graph.refresh()
                // }, 2000)
