    ...
    <main class="page" :style="pageStyle">
        ...
        <ModuleTransition delay="0.16">
            <footer v-if="recoShowModule" class="page-edit">
                <div class="edit-link" v-if="issuesLink">
                    {{editText}}
                    <a
                            :href="issuesLink"
                            target="_blank"
    ...
    export default defineComponent({
        ...
        setup(props, ctx) {
            ...
            const issuesLink = computed(() => {
                return (
                    instance.$themeLocaleConfig.issuesLink || instance.$themeConfig.issuesLink
                )
            })
            const editText = computed(() => {
                return (
                    instance.$themeLocaleConfig.editText || instance.$themeConfig.editText
                )
            })
            const issuesLinkText = computed(() => {
                return (
                    instance.$themeLocaleConfig.issuesLinkText || instance.$themeConfig.issuesLinkText
                )
            })
